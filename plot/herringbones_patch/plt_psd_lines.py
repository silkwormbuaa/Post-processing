...
i_temp          = 8
figname         = f'cdriblet_psd_1{50+i_temp:02d}'
fmat            = '.png'
figsize         = (12,6)
cases_nr        = [0,1,2]
showlegend      = False
premultiply     = True
normalize       = False
outpath         = '/home/wencan/temp/DataPost/cdriblets/psd/psd_without_normalization'

cases    = ['smooth_adiabatic', '250821',          '250821']
color    = ['gray',             'orangered',       'black'] 
label    = [r'$\mathcal{LS}$',  'con',             'div']
lstyle   = ['-',                '-.',               '--']
lwidth   = [4.0,                4.0,               4.0]
