...
for filename in lst:
    ...
    if filename.endswith(".dat"):
        ...
        print(fig_label)    
        plt.plot(yplus,uunor,label=r'$u^\prime u^\prime$',ls="--")
        plt.plot(yplus,uvnor,label=r'$u^\prime v^\prime$',ls="--")
        plt.plot(yplus,vvnor,label=r'$v^\prime v^\prime$',ls="--")
        plt.plot(yplus,wwnor,label=r'$w^\prime w^\prime$',ls="--")
...
plt.title("Reynolds Stress profile")      
#plt.xlim(0,1000)
plt.grid()
plt.show()
