...
@Desc    :   Read in snapshot_X_xxxx.bin files and show it with pyvista and matplotlib
'''
...
colmaps  = ['coolwarm',        'plasma',          'coolwarm',        'Greys', 
...
# -- read in the snapshot and compute density gradient
    ...
    for i, loc in enumerate(locs):
        ...
        for snapbl in snap.snap_data:
            ...
            snapbl.df['DS']       =  compute_DS( snapbl.df['wd'], min=0.0, max=2.0)
