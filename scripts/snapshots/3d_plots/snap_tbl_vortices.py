...
# -*- coding: utf-8 -*-
'''
@File    :   snap_tbl_vortices.py
@Time    :   2025/10/26
@Author  :   Wencan WU 
@Version :   1.0
@Email   :   w.wu-3@tudelft.nl
@Desc    :   visualise the isosurface of vortices in the upstream turbulent boundary layer
'''
...
# -- generate the vtk dataset
    ...
    dataset = pv.MultiBlock(snap3d.create_vtk_multiblock( vars=vars_out, block_list=block_list, buff=2, mode='oneside' ))
